...
<script>alert('Launch Initiated');</script>
 <%}
else{ 
	%>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <a href="SendEmail.jsp"><button type="submit" class="btn btn-warning" >Send Rich HTML Email<span class="glyphicon glyphicon-send"></span></button>
  </a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="SendTextEmail.jsp"><button type="submit" class="btn btn-warning" >Send Text Email<span class="glyphicon glyphicon-send"></span></button>
  </a></div>
</div>
