...
<form class="well form-horizontal" action="sendText.jsp" method="post" name="emailForm" id="emailForm" >
<fieldset>
<!-- Form Name -->
...
<!-- Email-->
  ...
  <input name="email" placeholder="To Address" class="form-control"  type="email" required>
    </div>
  </div>
</div>
